...
const AnamneseRepository_1 = require("../../repositories/implementations/AnamneseRepository");
let AnamneseService = class AnamneseService extends GenericService_1.GenericService {
    constructor(anamneseRepository) {
