...
async function main() {
    ...
    const permissions = [
        ...
        { name: "arquivo_exame_create", description: "Permissão para criar arquivo de exame" },
        { name: "arquivo_exame_read", description: "Permissão para ler arquivo de exame" },
        { name: "arquivo_exame_update", description: "Permissão para atualizar arquivo de exame" },
        { name: "arquivo_exame_delete", description: "Permissão para deletar arquivo de exame" },
        {
        ...
        { name: "evolucao_enfermagem_create", description: "Permissão para criar evolução de enfermagem" },
        { name: "evolucao_enfermagem_read", description: "Permissão para ler evolução de enfermagem" },
        { name: "evolucao_enfermagem_update", description: "Permissão para atualizar evolução de enfermagem" },
        { name: "evolucao_enfermagem_delete", description: "Permissão para deletar evolução de enfermagem" },
        ...
        { name: "alta_medica_delete", description: "Permissão para deletar alta médica" }, { name: "administracao_conduta_create", description: "Permissão para criar administração de conduta" },
        ...
        // Permissões para gerenciamento de autorização
        { name: "role_create", description: "Permissão para criar roles" },
        { name: "role_read", description: "Permissão para ler roles" },
        { name: "role_update", description: "Permissão para atualizar roles" },
        { name: "role_delete", description: "Permissão para deletar roles" },
        { name: "permission_create", description: "Permissão para criar permissions" },
        { name: "permission_read", description: "Permissão para ler permissions" },
        { name: "permission_update", description: "Permissão para atualizar permissions" },
        { name: "permission_delete", description: "Permissão para deletar permissions" },
        { name: "role_permission_create", description: "Permissão para criar associações role-permission" },
        { name: "role_permission_read", description: "Permissão para ler associações role-permission" },
        { name: "role_permission_delete", description: "Permissão para deletar associações role-permission" },
        { name: "user_role_create", description: "Permissão para criar associações user-role" },
        { name: "user_role_read", description: "Permissão para ler associações user-role" },
        { name: "user_role_delete", description: "Permissão para deletar associações user-role" },
    ];
    ...
    const rolesMap = await prisma.role
        .findMany({
    ...
    const permissionNames = [
        ...
        "arquivo_exame_read",
        "arquivo_exame_update",
        "arquivo_exame_delete",
        "prescricao_create",
        "prescricao_read",
        "prescricao_update",
        "prescricao_delete",
        ...
        "evolucao_enfermagem_create",
        "evolucao_enfermagem_read",
        "evolucao_enfermagem_update",
        "evolucao_enfermagem_delete",
        "alta_medica_create",
        "alta_medica_read",
        "alta_medica_update",
        "alta_medica_delete", "administracao_conduta_create",
        "administracao_conduta_read",
        "administracao_conduta_update",
        "administracao_conduta_delete",
        // Permissões de autorização
        "role_create",
        "role_read",
        "role_update",
        "role_delete",
    ...
    const permissionsMap = await prisma.permission
        .findMany({
    ...
    const rolePermissions = [
        {
            ...
            permissions: [
                ...
                "prescricao_create",
                "prescricao_read",
                "prescricao_update", "prescricao_delete", "evolucao_medica_create",
                "evolucao_medica_read",
                "evolucao_medica_update",
                "evolucao_medica_delete",
                "evolucao_enfermagem_create",
                ...
                "administracao_conduta_update",
                "administracao_conduta_delete",
                // Permissões de autorização para admin
                "role_create",
                "role_read",
                "role_update",
                "role_delete",
        ...
        },
        {
            ...
            permissions: [
                ...
                "exame_create",
                "exame_read",
                "arquivo_exame_read", "conduta_create",
                "conduta_read",
                "prescricao_create",
                "prescricao_read",
                // Permissões de autorização para gestor
                "role_create",
                "role_read",
                "role_update",
                "role_delete",
    ...
    await Promise.all(rolePermissions.flatMap(({ role, permissions }) => permissions.map((permission) => prisma.roleToPermission.upsert({
        where: {
            roleId_permissionId: {
    ...
    await Promise.all(patients.map((patient) => prisma.paciente.upsert({
    ...
    await Promise.all(appointments.map((appointment) => prisma.agendamento.upsert({
    ...
    await Promise.all(histories.map((history) => prisma.consulta.upsert({
        where: { id: history.id },
        update: {},
        create: history,
    })));
