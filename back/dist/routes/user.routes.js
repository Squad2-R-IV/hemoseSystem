 ...
 */
router.get("/:id", (0, asyncHandler_1.asyncHandler)(userController.getById.bind(userController)));
/**
 * @swagger
 * /users:
 *   post:
 ...
 *         description: Usuário não encontrado
 */
router.put("/:id", (0, asyncHandler_1.asyncHandler)(userController.update.bind(userController)));
/**
 * @swagger
 * /users/{id}:
 *   delete:
 ...
 *         description: Usuário não encontrado
 */
router.delete("/:id", (0, asyncHandler_1.asyncHandler)(userController.delete.bind(userController)));
