      ...
      <CardBody className="py-2 px-3 border-bottom">
        <div className="d-flex align-items-center gap-2 py-1">
          ...
          <div className="flex-grow-1">
            <h5 className="mb-0">
              <Link to="" className="text-reset lh-base">
                Adryan de Lima
              </Link>
            </h5>
            <p className="mb-0 text-muted">Diretor Geral</p>
          </div>
          <Dropdown className="lh-1" align={'end'}>
            ...
            <DropdownMenu className="dropdown-menu-end">
              <DropdownItem>
                ...
                />
                <span className="align-middle">Novo Contato</span>
              </DropdownItem>
              <DropdownItem>
                <IconifyIcon
                  ...
                  className="me-1 fs-17 align-middle"
                />
                <span className="align-middle">Novo Grupo</span>
              </DropdownItem>
              <DropdownItem>
                <IconifyIcon
                  icon="tabler:star"
                  className="me-1 fs-17 align-middle"
                />
                <span className="align-middle">Favoritos</span>
              </DropdownItem>
              <DropdownItem>
                <IconifyIcon
                  icon="tabler:archive"
                  className="me-1 fs-17 align-middle"
                />
                <span className="align-middle">Arquivar Contatos</span>
              </DropdownItem>
            </DropdownMenu>
          </Dropdown>
          <button
        ...
        <SimplebarReactClient className="users-list position-relative list-scroll">
          <div className="px-3 py-2">
            <div className="app-search py-1">
              ...
              <IconifyIcon
                icon="tabler:search"
                className="app-search-icon text-muted fs-16"
              />
            </div>
          </div>
          <div className="d-flex align-items-center px-3 py-2 bg-body-secondary position-sticky top-0 z-1">
            ...
            />
            <h5 className="mb-0 ms-1 fw-semibold fs-14">Fixados</h5>
          </div>
          {users?.map((item, idx) => (
            <Fragment key={idx}>
                ...
                >
                  ...
                  <div className="flex-grow-1 overflow-hidden">
                    ...
                    <p className="mt-1 mb-0 text-muted lh-1">
                      ...
                      {selectedUser?.activeOffline === 'Typing,,,,' &&
                      selectedUser.id === item.id ? (
                        ...
                        <>
                          <span className="w-75 d-inline-block text-truncate overflow-hidden">
                            {item.message}
                          </span>
                        </>
                      )}
              ...
              {item.allMessage && (
                <div className="d-flex align-items-center px-3 py-2 bg-body-secondary position-sticky top-0 z-1">
                  <IconifyIcon
                    ...
                    className="fs-18 text-muted"
                  />
                  <h5 className="mb-0 ms-1 fw-semibold fs-14">
                    Todas as Mensagens
                  </h5>
                </div>
              )}
