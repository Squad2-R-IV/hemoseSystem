        ...
        >
          <div className="p-3 border-bottom border-dashed">
            <Row className="align-items-center">
              <Col>
                <h6 className="m-0 fs-16 fw-semibold">Notificações</h6>
              </Col>
              <Col xs={'auto'}>
                <Dropdown>
                  <DropdownToggle
                  ...
                  <DropdownMenu className="dropdown-menu-end">
                    <DropdownItem>Marcar como Lida</DropdownItem>
                    <DropdownItem>Excluir Tudo</DropdownItem>
                    <DropdownItem>Não Perturbe</DropdownItem>
                    <DropdownItem>Outras Configurações</DropdownItem>
                  </DropdownMenu>
                </Dropdown>
              </Col>
            </Row>
