    ...
    <Row className="text-center justify-content-center my-4 g-2">
      <Col xs={6} sm={4} md={3} className="col-lg">
        <div className="bg-body-secondary border border-primary-subtle border-dashed p-2 rounded">
          ...
          <p className="fw-semibold fs-12 mb-0">Dias</p>
        </div>
      </Col>
      <Col xs={6} sm={4} md={3} className="col-lg">
        <div className="bg-body-secondary border border-primary-subtle border-dashed p-2 rounded">
          ...
          <p className="fw-semibold fs-12 mb-0">Horas</p>
        </div>
      </Col>
      <Col xs={6} sm={4} md={3} className="col-lg">
        <div className="bg-body-secondary border border-primary-subtle border-dashed p-2 rounded">
          ...
          <p className="fw-semibold fs-12 mb-0">Minutos</p>
        </div>
      </Col>
      <Col xs={6} sm={4} md={3} className="col-lg">
        <div className="bg-body-secondary border border-primary-subtle border-dashed p-2 rounded">
          ...
          <p className="fw-semibold fs-12 mb-0">Segundos</p>
        </div>
      </Col>
    </Row>
  );
