...
const LineColumnChart = () => {
  return (
    <ComponentContainerCard title="Gráfico de Linha e Coluna">
      <div dir="ltr">
        <ReactApexChart
          height={380}
...
const MultipleChart = () => {
  return (
    <ComponentContainerCard title="Gráfico com Múltiplos Eixos Y">
      <div dir="ltr">
        <ReactApexChart
          height={380}
...
const LineAreaChart = () => {
  return (
    <ComponentContainerCard title="Gráfico de Linha e Área">
      <div dir="ltr">
        <ReactApexChart
          height={380}
...
const LineColumnAreaChart = () => {
  return (
    <ComponentContainerCard title="Gráfico de Linha, Coluna e Área">
      <div dir="ltr">
        <ReactApexChart
          height={380}
