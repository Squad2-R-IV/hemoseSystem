...
const SimpleCandlestickChart = () => {
  return (
    <ComponentContainerCard title="Gráfico de Velas Simples">
      <div dir="ltr">
        <ReactApexChart
          height={400}
...
const CategoryChart = () => {
  return (
    <ComponentContainerCard title="Eixo X de Categoria">
      <div dir="ltr">
        <ReactApexChart
          height={400}
...
const CandlestickLineChart = () => {
  return (
    <ComponentContainerCard title="Candlestick com Linha">
      <div dir="ltr">
        <ReactApexChart
          height={380}
