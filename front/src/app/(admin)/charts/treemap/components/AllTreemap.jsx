...
const BasicTreemap = () => {
  return (
    <ComponentContainerCard title="Treemap Básico">
      <div dir="ltr">
        <ReactApexChart
          height={350}
...
const MultipleTreemap = () => {
  return (
    <ComponentContainerCard title="Treemap Múltiplas Séries">
      <div dir="ltr">
        <ReactApexChart
          height={350}
...
const DistributedTreemap = () => {
  return (
    <ComponentContainerCard title="Treemap Distribuído">
      <div dir="ltr">
        <ReactApexChart
          height={350}
...
const ColorTreemap = () => {
  return (
    <ComponentContainerCard title="Treemap com Faixa de Cores">
      <div dir="ltr">
        <ReactApexChart
          height={350}
