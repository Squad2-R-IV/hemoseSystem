...
const DynamicLoaded = () => {
  useEffect(() => {
    /**
     * Embaralha os elementos de um array no lugar.
     * Usando o algoritmo de embaralhamento Durstenfeld.
     */
    ...
    <>
      <Card>
        <CardHeader className="d-flex justify-content-between align-items-center">
          <h4 className="header-title">Gráfico Carregado Dinamicamente</h4>
