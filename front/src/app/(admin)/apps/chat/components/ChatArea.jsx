  ...
  return (
    ...
    >
      <DropdownToggle
        as={'a'}
        role="button"
        className="ps-1 link-reset  content-none "
      >
      ...
      <CardHeader className="py-2 px-3 border-bottom">
        <div className="d-flex align-items-center justify-content-between py-1">
              ...
              (selectedUser?.icon ? (
                ...
                <div className="avatar-lg rounded-circle bg-info text-white d-flex align-items-center justify-content-center">
                  <span className="fw-semibold">
                    {getFirstTwoLetters(selectedUser?.name)}
                  </span>
                </div>
              ))}
            <div>
              ...
              <p className="mb-0 text-muted icons-center">
                <IconifyIcon
                  ...
                  className={`text-${
                    selectedUser?.activeOffline == 'Offline'
                      ? 'danger'
                      : 'success'
                  } me-1`}
                />{' '}
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <Link
              to=""
              className="btn btn-sm btn-icon btn-ghost-light d-xl-flex"
            >
          ...
          >
            <Col xs={'auto'}>
              <Dropdown drop="up">
                <DropdownToggle
                  type="button"
                  className="btn btn-icon btn-soft-warning content-none"
                >
                  <IconifyIcon
