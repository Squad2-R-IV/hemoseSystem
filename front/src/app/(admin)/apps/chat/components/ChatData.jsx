  ...
  return <Card>
      <div className="chat d-flex">
        {users && selectedUser && <>
            ...
            <Offcanvas show={chatSetting.open} onHide={chatSetting.toggle} className="offcanvas-xxl offcanvas-start" tabIndex={-1} id="chatUserList" aria-labelledby="chatUserListLabel">
              <Chat users={users} onUserSelect={onUserChange} selectedUser={selectedUser} />
            </Offcanvas>
          </>}
